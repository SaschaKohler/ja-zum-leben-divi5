...
if ( ! defined( 'ET_BUILDER_PRODUCT_VERSION' ) ) {
	...
	define( 'ET_BUILDER_PRODUCT_VERSION', '5.0.0-public-alpha.22' );
}
...
function et_pb_all_role_options() {
	...
	if ( Conditions::is_d5_enabled() ) {
		$d5_core_modules_metadata = require ET_BUILDER_5_DIR . '/server/_all_modules_metadata.php';
		foreach ( $d5_core_modules_metadata as $module_slug => $module ) {
			...
			$all_modules_array[] = array(
				...
				'plural'             => esc_attr( $module['titles'] ),
				'label'              => esc_attr( $module_slug ),
				'is_official_module' => true,
				'use_unique_id'      => true,
			);
		}
