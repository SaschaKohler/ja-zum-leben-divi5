...
class DynamicContentOptionPostCategories extends DynamicContentOptionBase implements DynamicContentOptionInterface {
	...
	public function register_option_callback( array $options, int $post_id, string $context ): array {
		...
		if ( $is_tb_layout_post_type || ! empty( $public_post_types ) ) {
			...
			$taxonomy_options = [
				'category' => __( 'Categories', 'et_builder' ),
				'post_tag' => __( 'Tags', 'et_builder' ),
			];
			...
			$loop_fields = array_merge(
				...
				[
					...
					'links'         => [
						'label'   => esc_html__( 'Link To Taxonomy Pages', 'et_builder' ),
						'type'    => 'yes_no_button',
						'options' => [
							'on'  => et_builder_i18n( 'Yes' ),
							'off' => et_builder_i18n( 'No' ),
			...
			$options['loop_post_terms'] = [
				'id'     => 'loop_post_terms',
				'label'  => esc_html__( 'Loop Post Terms', 'et_builder' ),
				'type'   => 'text',
				'custom' => false,
				'group'  => 'Loop',
				'fields' => $loop_fields,
