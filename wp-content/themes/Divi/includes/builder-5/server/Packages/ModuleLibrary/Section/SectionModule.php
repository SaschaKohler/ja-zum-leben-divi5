...
class SectionModule implements DependencyInterface {
	...
	public static function module_styles( array $args ): void {
		...
		// Check if we're rendering inside a shortcode module context.
	 ...
	 *     }
	 *     @type array $attrs Optional. Full attrs object containing module decoration settings including z-index.
	 * }
