				...
				'styles'        => [
							...
							'styleProps' => [
								'border'    => [
									'propertySelectors' => [
										'desktop' => [
											'value' => [
												'border-radius' => "{$order_class}.et_pb_wc_reviews #reviews #comments ol.commentlist li img.avatar",
												'border-style' => "{$order_class}.et_pb_wc_reviews #reviews #comments ol.commentlist li img.avatar",
											],
										],
									],
								],
					...
					$elements->style(
						[
							...
							'styleProps' => [
								...
								'alignment'  => [
									'selector' => "{$order_class} .form-submit",
								],
								'background' => [
									'selector' => "{$order_class} .et_pb_button",
								],
								...
								'button'     => [
									'propertySelectors' => [
										'desktop' => [
											'value' => [
												'text-align' => "{$order_class} .form-submit",
											],
										],
									],
								],
					...
					$elements->style(
						[
							...
							'styleProps' => [
								'font' => [
									'selector' => "{$order_class} .comment-text .description",
								],
							],
						]
					),
					...
					$elements->style(
						[
							...
							'styleProps' => [
								'font' => [
									'selector' => "{$order_class} .comment-reply-title",
								],
							],
						]
					),
					...
					$elements->style(
						[
							...
							'styleProps' => [
								'font' => [
									'selector'  => "{$order_class} #reviews #comments ol.commentlist li .comment-text p.meta, {$order_class} .comment-form-rating label",
									'important' => true,
								],
							],
						]
					...
					$elements->style(
						[
							...
							'styleProps' => [
								'font' => [
									'selector' => "{$order_class} h1.woocommerce-Reviews-title, {$order_class} h2.woocommerce-Reviews-title, {$order_class} h3.woocommerce-Reviews-title, {$order_class} h4.woocommerce-Reviews-title, {$order_class} h5.woocommerce-Reviews-title, {$order_class} h6.woocommerce-Reviews-title",
								],
							],
						]
					),
					...
					$elements->style(
						[
							...
							'styleProps' => [
								'font' => [
									'selector'          => "{$order_class} .star-rating, {$order_class} .comment-form-rating p.stars a",
									'propertySelectors' => [
										'font' => [
											'desktop' => [
												'hover' => [
													'color' => "{$order_class} .star-rating:hover > span:before, {$order_class} .comment-form-rating p.stars:hover a",
													'letter-spacing' => "{$order_class} .star-rating:hover, {$order_class} .comment-form-rating p.stars:hover",
												],
												'value' => [
													...
													'text-align' => "{$order_class} .star-rating, {$order_class} .comment-form-rating p.stars",
												],
											],
										],
									],
