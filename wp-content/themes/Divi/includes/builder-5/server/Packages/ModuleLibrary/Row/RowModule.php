...
class RowModule implements DependencyInterface {
	...
	public static function module_classnames( array $args ): void {
		...
		$classnames_instance->add( 'et_pb_equal_columns', $is_make_equal_on && 'stretch' === $align_columns );
	...
	public static function child_column_style_declaration( array $params ) {
		...
		// Only output the CSS variable if columnGap is set and not empty.
		if ( is_string( $column_gap ) && '' !== $column_gap ) {
			$style_declarations->add( '--row-gutter-horizontal', $column_gap );
		}
